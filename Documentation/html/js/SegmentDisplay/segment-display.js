  ...
  if (display) {
    ...
    if (context) {
      ...
      for (var i = 0; i < this.pattern.length; i++) {
        ...
        var value = (i < size) ? this.value.charAt(i) : ' ';
  ...
  switch (mask) {
    case '#':
      ...
      if (this.segmentCount == 16) {
        ...
        var x = xPos;
        var y = 0;
        context.fillStyle = this.getSegmentColor(c, '02356789ACEFGMNOPQRSZaefgpqsz', '02356789abcdefgiopqrstz@');
        context.beginPath();
        switch (this.cornerType) {
          case SegmentDisplay.SymmetricCorner:
            context.moveTo(x + s + d, y + s);
      ...
      y = 0;
      context.fillStyle = this.getSegmentColor(c, '01234789ADGIHJKMNOPQUVWXYZadegjkpqyxz', '01234789abdhjmnopqruwy');
      context.beginPath();
      switch (this.cornerType) {
        case SegmentDisplay.SymmetricCorner:
      ...
      context.fillStyle = this.getSegmentColor(c, '013456789ABDGHIJKMNOQSUVWXYabdghijkmnoqsuvwxy', '01346789abdghjmnoqsuw@', '%');
      context.beginPath();
      ...
      if (this.segmentCount == 16) {
        ...
        x = xPos;
        y = this.digitHeight - this.segmentWidth;
        context.fillStyle = this.getSegmentColor(c, '0235689BCDEGJLOSTUVWYZabcdegjlostuvwyz_=', '0235689bcdegijloqsuz_=@');
        context.beginPath();
        context.moveTo(x + this.segmentWidth + d, y);
        context.lineTo(x + this.digitWidth - this.segmentWidth - d, y);
        switch (this.cornerType) {
      ...
      x = xPos;
      y = h + this.segmentWidth;
      context.fillStyle = this.getSegmentColor(c, '0268ABCDEFHJKLMNOPRTUVWXZabcdefhjklmnoprtuvwxz', '0268acefghjklmnopqruvw@');
      context.beginPath();
      context.moveTo(x, y + this.segmentWidth + d);
      context.lineTo(x + s, y + s + d);
      context.lineTo(x + this.segmentWidth, y + this.segmentWidth + d);
      ...
      x = xPos;
      y = 0;
      context.fillStyle = this.getSegmentColor(c, '045689ABCEFGHKLMNOPQRSTUVWXYbefghklpqstxy', '045689acefghklmnopqrsuvwy@', '%');
      context.beginPath();
      ...
      if (this.segmentCount == 7) {
        ...
        context.fillStyle = this.getSegmentColor(c, '2345689ABDEFGHKPQSTXYZabcdefghkmnopqrstxyz-=');
        context.beginPath();
        context.moveTo(x + s + d, y + s);
        context.lineTo(x + this.segmentWidth + d, y);
        context.lineTo(x + this.digitWidth - this.segmentWidth - d, y);
